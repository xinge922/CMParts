...
public class UIPieActivity extends PreferenceActivity implements OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int pieGravity = Settings.System.getInt(getContentResolver(), Settings.System.PIE_GRAVITY, 3);
        ...
        int pieMode = Settings.System.getInt(getContentResolver(), Settings.System.PIE_MODE, 2);
        ...
        String pieSize = Settings.System.getString(getContentResolver(), Settings.System.PIE_SIZE);
        ...
        mPieEnableColor.setChecked((Settings.System.getInt(getContentResolver(), Settings.System.PIE_ENABLE_COLOR, 0) == 1));
        ...
        if (mNavBarEnabled) {
            ...
            alertDialog.setButton(DialogInterface.BUTTON_POSITIVE, getResources().getString(com.android.internal.R.string.ok),
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mPieMode) {
            ...
            Settings.System.putInt(getContentResolver(), Settings.System.PIE_MODE, pieMode);
            return true;
        } else if (preference == mPieSize) {
            float pieSize = Float.valueOf((String) newValue);
            Settings.System.putFloat(getContentResolver(), Settings.System.PIE_SIZE, pieSize);
            return true;
        } else if (preference == mPieGravity) {
            int pieGravity = Integer.valueOf((String) newValue);
            Settings.System.putInt(getContentResolver(), Settings.System.PIE_GRAVITY, pieGravity);
            return true;
        } else if (preference == mPieGap) {
            int pieGap = Integer.valueOf((String) newValue);
            Settings.System.putInt(getContentResolver(), Settings.System.PIE_GAP, pieGap);
            return true;
        } else if (preference == mPieTrigger) {
            float pieTrigger = Float.valueOf((String) newValue);
            Settings.System.putFloat(getContentResolver(), Settings.System.PIE_TRIGGER, pieTrigger);
            return true;
        }
        return false;
    }
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mPieButtonColor) {
            ...
            Settings.System.putInt(getContentResolver(), Settings.System.PIE_ENABLE_COLOR, mPieEnableColor.isChecked() ? 1 : 0);
            return true;
    ...
    private int defValuesColor() {
        return getResources().getInteger(R.color.holo_blue_light);
    }
